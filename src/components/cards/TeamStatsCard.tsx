          ...
          {rows.map((row) => (
            <tr key={row.n}>
              <td className="border-b border-border/30 py-2">
                {t("goalsTable.atLeast", { n: row.n })}
              </td>
              <td className="border-b border-border/30 py-2 text-right text-cyan">{row.xg}</td>
              <td className="border-b border-border/30 py-2 text-right text-green">{row.xgot}</td>
              <td className="border-b border-border/30 py-2">
